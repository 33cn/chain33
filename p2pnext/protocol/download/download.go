...
func (d *DownloadProtol) handleEvent(msg *queue.Message) {
	...
	log.Info("handleEvent", "download start>>>>>>>>>>", req.GetStart(), "end", req.GetEnd(), "pids", pids, "jobID", jobID)
...
func (d *DownloadProtol) availJob(js jobs) *JobInfo {
