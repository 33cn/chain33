...
// GetTimeStatus provides a mock function with given fields:
func (_m *QueueProtocolAPI) GetTimeStatus() (*types.TimeStatus, error) {
	ret := _m.Called()

	var r0 *types.TimeStatus
	if rf, ok := ret.Get(0).(func() *types.TimeStatus); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.TimeStatus)
		}
	}
