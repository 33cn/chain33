...
func (*ValNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ValNodes) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*ValNodeAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type ValNodeAction_BlockInfo struct {
	BlockInfo *types3.TendermintBlockInfo `protobuf:"bytes,2,opt,name=blockInfo,oneof"`
}
...
func (m *ValNodeAction) GetBlockInfo() *types3.TendermintBlockInfo {
...
func _ValNodeAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // value.blockInfo
		...
		msg := new(types3.TendermintBlockInfo)
		err := b.DecodeMessage(msg)
...
func (*ReqNodeInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*ReqBlockInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func init() { proto.RegisterFile("valnode.proto", fileDescriptor0) }
