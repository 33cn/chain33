...
func (h *Hashlock) Exec_Hsend(transfer *pty.HashlockUnlock, tx *types.Transaction, index int) (*types.Receipt, error) {
...
func (h *Hashlock) Exec_Hunlock(transfer *pty.HashlockSend, tx *types.Transaction, index int) (*types.Receipt, error) {
