...
import fmt "fmt"
import math "math"
import types1 "gitlab.33.cn/chain33/chain33/system/dapp/coins/types"
...
type ParacrossAction_AssetTransfer struct {
	AssetTransfer *types1.CoinsTransfer `protobuf:"bytes,4,opt,name=assetTransfer,oneof"`
}
type ParacrossAction_AssetWithdraw struct {
	AssetWithdraw *types1.CoinsWithdraw `protobuf:"bytes,5,opt,name=assetWithdraw,oneof"`
}
...
func (m *ParacrossAction) GetAssetTransfer() *types1.CoinsTransfer {
...
func (m *ParacrossAction) GetAssetWithdraw() *types1.CoinsWithdraw {
...
var fileDescriptor0 = []byte{
	...
	,
}
