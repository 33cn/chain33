...
func routes(m *monitor.Monitor) map[string]*rpc.RPCFunc {
	return map[string]*rpc.RPCFunc{
		...
		"status/network_status": rpc.NewRPCFunc(RPCNetworkStatus(m), ""),
