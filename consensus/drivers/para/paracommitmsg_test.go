...
//
//	msg := queue.Message{}
//	s.qClient.On("NewMessage", "blockchain", types.EventGetLastBlock, nil).Return(msg).Once()
//	s.qClient.On("Send", msg, true).Return(nil).Once()
//	msg2 := queue.Message{Data: nil}
//	s.qClient.On("Wait", msg).Return(msg2, nil).Once()
//
//	s.para.InitBlock()
//	block,err := s.para.RequestLastBlock()
//	if err != nil{
//		panic("err")
//	}
//	plog.Info("test","height",block.Height)
//	s.para.createBlock(block,nil,1,s.getMainBlock(1))
//
//	msg = queue.Message{}
...
//}
//
//func (s *suiteParaCommitMsg)getMainBlock(height int64) *types.Block {
//	return &types.Block{
//		Height:height,
//	}
//}
