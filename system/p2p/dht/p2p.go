...
func (p *P2P) StartP2P() {
	...
	log.Info("NewP2p", "peerId", p.host.ID(), "addrs", p.host.Addrs(), "hexPubkeyxxxxxxxxxxxxxxxxxxxxxxxxxxxx", hex.EncodeToString(pbs))
...
func (p *P2P) CloseP2P() {
	...
	log.Info("p2p closeddddddddddddddddddddddddddd")
}
