...
func Test_sendQueryData(t *testing.T) {
	...
	_, ok := proto.handleSend(&types.P2PQueryData{}, testPidStr, testAddr)
	assert.True(t, ok)
}
...
func Test_sendQueryReply(t *testing.T) {
	...
	proto := newTestProtocol()
	_, ok := proto.handleSend(&types.P2PBlockTxReply{}, testPidStr, testAddr)
	assert.True(t, ok)
}
...
func Test_recvQueryData(t *testing.T) {
	...
	sendData, _ := proto.handleSend(query, testPidStr, testAddr)
...
func Test_recvQueryReply(t *testing.T) {
	...
	sendData, _ := proto.handleSend(reply, testPidStr, testAddr)
	err := proto.handleReceive(sendData, testPidStr, testAddr, broadcastV2)
