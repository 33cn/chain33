...
//	env.Ctx = ctx
//	env.Pubsub = pubsub
//	discovery := net.InitDhtDiscovery(env.Ctx, host, nil, cfg, subCfg)
//	env.RoutingDiscovery = discovery.RoutingDiscovery
//	env.ConnManager = manage.NewConnManager(host, discovery, nil, subCfg)
//
//	return env
//}
//
//func newTestProtocolWithQueue(q queue.Queue) *Protocol {
//	env := newTestEnv(q)
//	p := &Protocol{}
...
//}
//
//func newTestProtocol(q queue.Queue) *Protocol {
//
...
//}
//
//func testHandleEvent(protocol *Protocol, msg *queue.Message) {
//
//	defer func() {
//		if r := recover(); r != nil {
//		}
//	}()
//
//	protocol.handleEventPeerInfo(msg)
//}
//func testNetInfoHandleEvent(protocol *Protocol, msg *queue.Message) {
//
//	defer func() {
//		if r := recover(); r != nil {
//		}
//	}()
//
//	protocol.handleEventNetInfo(msg)
//}
//
...
//	testMempoolReq(q)
//	testBlockReq(q)
//	peerinfo := proto.getLocalPeerInfo()
