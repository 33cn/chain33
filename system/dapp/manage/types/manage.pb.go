...
type ApplyConfig struct {
	...
	Modify *types.ModifyConfig `protobuf:"bytes,1,opt,name=modify,proto3" json:"modify,omitempty"`
}
...
func (x *ApplyConfig) GetModify() *types.ModifyConfig {
	if x != nil {
		return x.Modify
	}
	return nil
...
type ApproveConfig struct {
	...
	Id        string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`               //修改配置项申请ID
	ApproveId string `protobuf:"bytes,2,opt,name=approveId,proto3" json:"approveId,omitempty"` // approve 合约批准的ID
}
...
func (x *ApproveConfig) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ApproveConfig) GetApproveId() string {
	if x != nil {
		return x.ApproveId
	}
	return ""
...
type ConfigStatus struct {
	...
	Modify   *types.ModifyConfig `protobuf:"bytes,2,opt,name=modify,proto3" json:"modify,omitempty"`
...
func (x *ConfigStatus) GetModify() *types.ModifyConfig {
	if x != nil {
		return x.Modify
	}
	return nil
...
var file_manage_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x2b, 0x0a, 0x06, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x4d, 0x6f, 0x64,
	0x69, 0x66, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x6d, 0x6f, 0x64, 0x69, 0x66,
	0x79, 0x22, 0x3d, 0x0a, 0x0d, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x49, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x49, 0x64,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x2b, 0x0a, 0x06, 0x6d, 0x6f, 0x64, 0x69,
	0x66, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x2e, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x6d,
	0x6f, 0x64, 0x69, 0x66, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
