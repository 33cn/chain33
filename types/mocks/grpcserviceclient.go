...
func (_m *GrpcserviceClient) CreateRawTxGroup(ctx context.Context, in *types.CreateTransactionGroup, opts ...grpc.CallOption) (*types.UnsignTx, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *GrpcserviceClient) EnablePrivacy(ctx context.Context, in *types.ReqEnablePrivacy, opts ...grpc.CallOption) (*types.RepEnablePrivacy, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
