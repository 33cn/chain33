...
// QueryTransactionFormat provides a mock function with given fields: ctx, in, opts
func (_m *Chain33Client) QueryTransactionFormat(ctx context.Context, in *types.ReqHash, opts ...grpc.CallOption) (*types.TxDetailFormat, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *types.TxDetailFormat
	if rf, ok := ret.Get(0).(func(context.Context, *types.ReqHash, ...grpc.CallOption) *types.TxDetailFormat); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.TxDetailFormat)
		}
	}
