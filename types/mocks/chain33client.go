...
func (_m *Chain33Client) DumpPrivkeysFile(ctx context.Context, in *types.ReqString, opts ...grpc.CallOption) (*types.Reply, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *Chain33Client) ImportPrivkeysFile(ctx context.Context, in *types.ReqString, opts ...grpc.CallOption) (*types.Reply, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
