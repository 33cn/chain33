...
type Para struct {
	ParaId     []byte `protobuf:"bytes,1,opt,name=ParaId,proto3" json:"ParaId,omitempty"`
	CreateTime int64  `protobuf:"varint,2,opt,name=createTime" json:"createTime,omitempty"`
	Key        string `protobuf:"bytes,3,opt,name=key" json:"key,omitempty"`
	Value      []byte `protobuf:"bytes,4,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (*Para) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{58} }

func (m *Para) GetParaId() []byte {
	if m != nil {
		return m.ParaId
	}
	return nil
...
func (m *Para) GetCreateTime() int64 {
	if m != nil {
		return m.CreateTime
	}
	return 0
...
type ParaAction struct {
	// Types that are valid to be assigned to Value:
	//	*ParaAction_Put
	Value isParaAction_Value `protobuf_oneof:"value"`
	Ty    int32              `protobuf:"varint,5,opt,name=ty" json:"ty,omitempty"`
}

func (m *ParaAction) Reset()                    { *m = ParaAction{} }
func (m *ParaAction) String() string            { return proto.CompactTextString(m) }
func (*ParaAction) ProtoMessage()               {}
func (*ParaAction) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{59} }

type isParaAction_Value interface {
	isParaAction_Value()
}

type ParaAction_Put struct {
	Put *ParaPut `protobuf:"bytes,1,opt,name=put,oneof"`
}

func (*ParaAction_Put) isParaAction_Value() {}

func (m *ParaAction) GetValue() isParaAction_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *ParaAction) GetPut() *ParaPut {
	if x, ok := m.GetValue().(*ParaAction_Put); ok {
		return x.Put
	}
	return nil
}

func (m *ParaAction) GetTy() int32 {
	if m != nil {
		return m.Ty
	}
	return 0
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ParaAction) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ParaAction_OneofMarshaler, _ParaAction_OneofUnmarshaler, _ParaAction_OneofSizer, []interface{}{
		(*ParaAction_Put)(nil),
	}
}

func _ParaAction_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ParaAction)
	// value
	switch x := m.Value.(type) {
	case *ParaAction_Put:
	...
	case nil:
	default:
		return fmt.Errorf("ParaAction.Value has unexpected type %T", x)
	}
	return nil
}

func _ParaAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ParaAction)
	switch tag {
	case 1: // value.put
		if wire != proto.WireBytes {
...
func _ParaAction_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ParaAction)
	// value
	switch x := m.Value.(type) {
	case *ParaAction_Put:
...
func (m *ParaPut) Reset()                    { *m = ParaPut{} }
func (m *ParaPut) String() string            { return proto.CompactTextString(m) }
func (*ParaPut) ProtoMessage()               {}
func (*ParaPut) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{60} }

func (m *ParaPut) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*Para)(nil), "types.Para")
	proto.RegisterType((*ParaAction)(nil), "types.ParaAction")
	proto.RegisterType((*ParaPut)(nil), "types.ParaPut")
}
...
var fileDescriptor6 = []byte{
	...
	0x15, 0x77, 0x4f, 0x4f, 0xcf, 0x78, 0xde, 0x8c, 0x27, 0xeb, 0x5e, 0x63, 0x59, 0x51, 0x14, 0xa2,
	0x5e, 0x93, 0xf5, 0x92, 0xdd, 0xec, 0xae, 0xc3, 0x4a, 0x88, 0x0b, 0x72, 0x0c, 0xcb, 0x18, 0x92,
	0xc5, 0x54, 0xbc, 0x89, 0x16, 0x24, 0x96, 0x76, 0x77, 0x8d, 0xdd, 0xf2, 0x4c, 0x77, 0xa7, 0xba,
	...
	,
}
