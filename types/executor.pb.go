...
func (*Genesis) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{0}
}
...
func (*ExecTxList) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{1}
}
...
func (*Query) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{2}
}
...
func (*CreateTxIn) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{3}
}
...
func (*ArrayConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{4}
}
...
func (*StringConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{5}
}
...
func (*Int32Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{6}
}
...
func (*ConfigItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{7}
}
...
func (*ModifyConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{8}
}
...
func (*ReceiptConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{9}
}
...
func (*ReplyConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{10}
}
...
func (*HistoryCertStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_18a9d8488bdc033d, []int{11}
}
...
func init() { proto.RegisterFile("executor.proto", fileDescriptor_executor_18a9d8488bdc033d) }

var fileDescriptor_executor_18a9d8488bdc033d = []byte{
