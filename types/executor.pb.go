...
func (*Genesis) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{0}
}
...
func (*ExecTxList) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{1}
}
...
func (*Query) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{2}
}
...
func (*CreateTxIn) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{3}
}
...
func (*ArrayConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{4}
}
...
func (*StringConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{5}
}
...
func (*Int32Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{6}
}
...
func (*ConfigItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{7}
}
...
func (*ModifyConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{8}
}
...
func (*ReceiptConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{9}
}
...
func (*ReplyConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{10}
}
...
func (*HistoryCertStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_executor_14090b06a5700668, []int{11}
}
...
func init() { proto.RegisterFile("executor.proto", fileDescriptor_executor_14090b06a5700668) }

var fileDescriptor_executor_14090b06a5700668 = []byte{
