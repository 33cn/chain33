...
func (*LeafNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{0}
}
...
func (*InnerNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{1}
}
...
func (*MAVLProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{2}
}
...
func (*StoreNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{3}
}
...
func (*LocalDBSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{4}
}
...
func (*LocalDBList) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{5}
}
...
func (*LocalDBGet) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{6}
}
...
func (*LocalReplyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{7}
}
...
func (*StoreSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{8}
}
...
func (*StoreDel) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{9}
}
...
func (*StoreSetWithSync) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{10}
}
...
func (*StoreGet) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{11}
}
...
func (*StoreReplyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{12}
}
...
func (*StoreList) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{13}
}
...
func (*StoreListReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{14}
}
...
func (*PruneData) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{15}
}
...
func (*StoreValuePool) Descriptor() ([]byte, []int) {
	return fileDescriptor_db_366880092e811caa, []int{16}
}
...
func init() { proto.RegisterFile("db.proto", fileDescriptor_db_366880092e811caa) }

var fileDescriptor_db_366880092e811caa = []byte{
