...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	0x91, 0xbb, 0x01, 0xfb, 0x46, 0xcb, 0x37, 0x47, 0x88, 0x4c, 0x2a, 0x24, 0x15, 0xdb, 0x3f, 0x67,
	0xff, 0x74, 0x20, 0x25, 0xea, 0xdd, 0x49, 0xfa, 0x4d, 0xbc, 0xbb, 0xe7, 0x78, 0x24, 0x9f, 0x7b,
	...
	,
}
...
type Chain33Client interface {
	...
	//通过block seq 获取对应的blocks hash 信息
	GetForwardDelBlock(ctx context.Context, in *ReqHash, opts ...grpc.CallOption) (*BlockSeq, error)
	//关闭chain33
...
func (c *chain33Client) GetForwardDelBlock(ctx context.Context, in *ReqHash, opts ...grpc.CallOption) (*BlockSeq, error) {
	out := new(BlockSeq)
...
type Chain33Server interface {
	...
	//通过block seq 获取对应的blocks hash 信息
	GetForwardDelBlock(context.Context, *ReqHash) (*BlockSeq, error)
	//关闭chain33
...
func _Chain33_GetForwardDelBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Chain33Server).GetForwardDelBlock(ctx, req.(*ReqHash))
	}
	return interceptor(ctx, in, info, handler)
}
