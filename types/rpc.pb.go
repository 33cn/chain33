...
type Chain33Client interface {
	...
	// 根据哈希查询交易, 对返回数据进行了格式化,和jsonrpc QueryTransaction保持一致
	QueryTransactionFormat(ctx context.Context, in *ReqHash, opts ...grpc.CallOption) (*TxDetailFormat, error)
	// 发送交易
...
func (c *chain33Client) QueryTransactionFormat(ctx context.Context, in *ReqHash, opts ...grpc.CallOption) (*TxDetailFormat, error) {
	out := new(TxDetailFormat)
	err := c.cc.Invoke(ctx, "/types.chain33/QueryTransactionFormat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type Chain33Server interface {
	...
	// 根据哈希查询交易, 对返回数据进行了格式化,和jsonrpc QueryTransaction保持一致
	QueryTransactionFormat(context.Context, *ReqHash) (*TxDetailFormat, error)
	// 发送交易
...
func _Chain33_QueryTransactionFormat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReqHash)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Chain33Server).QueryTransactionFormat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.chain33/QueryTransactionFormat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Chain33Server).QueryTransactionFormat(ctx, req.(*ReqHash))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Chain33_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryTransactionFormat",
			Handler:    _Chain33_QueryTransactionFormat_Handler,
		},
		{
...
func init() { proto.RegisterFile("rpc.proto", fileDescriptor_rpc_e9d53a1256f2b122) }

var fileDescriptor_rpc_e9d53a1256f2b122 = []byte{
	...
	,
}
