...
type Chain33Client interface {
	...
	// 获取拥有此title交易的区块高度
	LoadParaTxByTitle(ctx context.Context, in *ReqHeightByTitle, opts ...grpc.CallOption) (*HeightParas, error)
...
func (c *chain33Client) LoadParaTxByTitle(ctx context.Context, in *ReqHeightByTitle, opts ...grpc.CallOption) (*HeightParas, error) {
	out := new(HeightParas)
...
type Chain33Server interface {
	...
	// 获取拥有此title交易的区块高度
	LoadParaTxByTitle(context.Context, *ReqHeightByTitle) (*HeightParas, error)
	// 通过区块高度列表+title获取平行链交易
...
func init() { proto.RegisterFile("rpc.proto", fileDescriptor_rpc_5764c93a30b574f1) }

var fileDescriptor_rpc_5764c93a30b574f1 = []byte{
	...
	,
}
