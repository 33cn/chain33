...
type GrpcserviceClient interface {
	...
	// 关闭chain33
	CloseQueue(ctx context.Context, in *ReqNil, opts ...grpc.CallOption) (*ReqNil, error)
}
...
func (c *grpcserviceClient) CloseQueue(ctx context.Context, in *ReqNil, opts ...grpc.CallOption) (*ReqNil, error) {
	out := new(ReqNil)
...
type GrpcserviceServer interface {
	...
	// 关闭chain33
	CloseQueue(context.Context, *ReqNil) (*ReqNil, error)
}
...
var fileDescriptor10 = []byte{
	...
	,
}
