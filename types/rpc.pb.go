...
type Chain33Client interface {
	...
	// 获取随机HASH
	QueryRandNum(ctx context.Context, in *ReqInt, opts ...grpc.CallOption) (*ReplyHash, error)
}
...
func (c *chain33Client) QueryRandNum(ctx context.Context, in *ReqInt, opts ...grpc.CallOption) (*ReplyHash, error) {
	out := new(ReplyHash)
...
type Chain33Server interface {
	...
	// 获取随机HASH
	QueryRandNum(context.Context, *ReqInt) (*ReplyHash, error)
}
...
func _Chain33_QueryRandNum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Chain33Server).QueryRandNum(ctx, req.(*ReqInt))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("rpc.proto", fileDescriptor_rpc_203bda9ee28db91a) }

var fileDescriptor_rpc_203bda9ee28db91a = []byte{
	// 1009 bytes of a gzipped FileDescriptorProto
	,
}
