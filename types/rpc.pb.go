...
var file_rpc_proto_rawDesc = []byte{
	...
	0x61, 0x32, 0xe0, 0x1d, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x33, 0x33, 0x12, 0x2d, 0x0a,
	...
	0x00, 0x12, 0x3d, 0x0a, 0x10, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x13, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x12, 0x2e, 0x74, 0x79, 0x70,
	...
	0x73, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0e, 0x47, 0x65, 0x74,
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*Transactions)(nil),             // 11: types.Transactions
	(*ReqAddr)(nil),                  // 12: types.ReqAddr
	(*ReqHashes)(nil),                // 13: types.ReqHashes
	(*ReqGetMempool)(nil),            // 14: types.ReqGetMempool
	(*ReqGetAccount)(nil),            // 15: types.ReqGetAccount
	(*ReqNewAccount)(nil),            // 16: types.ReqNewAccount
	(*ReqWalletTransactionList)(nil), // 17: types.ReqWalletTransactionList
	(*ReqWalletImportPrivkey)(nil),   // 18: types.ReqWalletImportPrivkey
	(*ReqWalletSendToAddress)(nil),   // 19: types.ReqWalletSendToAddress
	(*ReqWalletSetFee)(nil),          // 20: types.ReqWalletSetFee
	(*ReqWalletSetLabel)(nil),        // 21: types.ReqWalletSetLabel
	(*ReqWalletMergeBalance)(nil),    // 22: types.ReqWalletMergeBalance
	(*ReqWalletSetPasswd)(nil),       // 23: types.ReqWalletSetPasswd
	(*WalletUnLock)(nil),             // 24: types.WalletUnLock
	(*ReqProperFee)(nil),             // 25: types.ReqProperFee
	(*ReqInt)(nil),                   // 26: types.ReqInt
	(*GenSeedLang)(nil),              // 27: types.GenSeedLang
	(*GetSeedByPw)(nil),              // 28: types.GetSeedByPw
	(*SaveSeedByPw)(nil),             // 29: types.SaveSeedByPw
	(*ReqBalance)(nil),               // 30: types.ReqBalance
	(*ChainExecutor)(nil),            // 31: types.ChainExecutor
	(*CreateTxIn)(nil),               // 32: types.CreateTxIn
	(*ReqString)(nil),                // 33: types.ReqString
	(*ReqPrivkeysFile)(nil),          // 34: types.ReqPrivkeysFile
	(*P2PGetPeerReq)(nil),            // 35: types.P2PGetPeerReq
	(*P2PGetNetInfoReq)(nil),         // 36: types.P2PGetNetInfoReq
	(*Int64)(nil),                    // 37: types.Int64
	(*ReqAllExecBalance)(nil),        // 38: types.ReqAllExecBalance
	(*ReqSignRawTx)(nil),             // 39: types.ReqSignRawTx
	(*NoBalanceTx)(nil),              // 40: types.NoBalanceTx
	(*ReqRandHash)(nil),              // 41: types.ReqRandHash
	(*ReqKey)(nil),                   // 42: types.ReqKey
	(*NoBalanceTxs)(nil),             // 43: types.NoBalanceTxs
	(*ReqParaTxByTitle)(nil),         // 44: types.ReqParaTxByTitle
	(*ReqHeightByTitle)(nil),         // 45: types.ReqHeightByTitle
	(*ReqParaTxByHeight)(nil),        // 46: types.ReqParaTxByHeight
	(*Reply)(nil),                    // 47: types.Reply
	(*Header)(nil),                   // 48: types.Header
	(*UnsignTx)(nil),                 // 49: types.UnsignTx
	(*TransactionDetail)(nil),        // 50: types.TransactionDetail
	(*ReplyHashes)(nil),              // 51: types.ReplyHashes
	...
	(*ReplyProperFee)(nil),           // 59: types.ReplyProperFee
	(*WalletStatus)(nil),             // 60: types.WalletStatus
	(*BlockOverview)(nil),            // 61: types.BlockOverview
	(*AddrOverview)(nil),             // 62: types.AddrOverview
	(*ReplySeed)(nil),                // 63: types.ReplySeed
	(*Accounts)(nil),                 // 64: types.Accounts
	(*HexTx)(nil),                    // 65: types.HexTx
	(*ReplyString)(nil),              // 66: types.ReplyString
	(*VersionInfo)(nil),              // 67: types.VersionInfo
	(*PeerList)(nil),                 // 68: types.PeerList
	(*NodeNetInfo)(nil),              // 69: types.NodeNetInfo
	(*Int32)(nil),                    // 70: types.Int32
	(*BlockDetails)(nil),             // 71: types.BlockDetails
	(*BlockSeq)(nil),                 // 72: types.BlockSeq
	(*AllExecBalance)(nil),           // 73: types.AllExecBalance
	(*ReplySignRawTx)(nil),           // 74: types.ReplySignRawTx
	(*ParaTxDetails)(nil),            // 75: types.ParaTxDetails
	(*ReplyHeightByTitle)(nil),       // 76: types.ReplyHeightByTitle
	(*Headers)(nil),                  // 77: types.Headers
}
var file_rpc_proto_depIdxs = []int32{
	...
	11, // 9: types.chain33.SendTransactions:input_type -> types.Transactions
	12, // 10: types.chain33.GetTransactionByAddr:input_type -> types.ReqAddr
	13, // 11: types.chain33.GetTransactionByHashes:input_type -> types.ReqHashes
	14, // 12: types.chain33.GetMemPool:input_type -> types.ReqGetMempool
	7,  // 13: types.chain33.GetAccounts:input_type -> types.ReqNil
	15, // 14: types.chain33.GetAccount:input_type -> types.ReqGetAccount
	16, // 15: types.chain33.NewAccount:input_type -> types.ReqNewAccount
	17, // 16: types.chain33.WalletTransactionList:input_type -> types.ReqWalletTransactionList
	18, // 17: types.chain33.ImportPrivkey:input_type -> types.ReqWalletImportPrivkey
	19, // 18: types.chain33.SendToAddress:input_type -> types.ReqWalletSendToAddress
	20, // 19: types.chain33.SetTxFee:input_type -> types.ReqWalletSetFee
	21, // 20: types.chain33.SetLabl:input_type -> types.ReqWalletSetLabel
	22, // 21: types.chain33.MergeBalance:input_type -> types.ReqWalletMergeBalance
	23, // 22: types.chain33.SetPasswd:input_type -> types.ReqWalletSetPasswd
	7,  // 23: types.chain33.Lock:input_type -> types.ReqNil
	24, // 24: types.chain33.UnLock:input_type -> types.WalletUnLock
	7,  // 25: types.chain33.GetLastMemPool:input_type -> types.ReqNil
	25, // 26: types.chain33.GetProperFee:input_type -> types.ReqProperFee
	7,  // 27: types.chain33.GetWalletStatus:input_type -> types.ReqNil
	10, // 28: types.chain33.GetBlockOverview:input_type -> types.ReqHash
	12, // 29: types.chain33.GetAddrOverview:input_type -> types.ReqAddr
	26, // 30: types.chain33.GetBlockHash:input_type -> types.ReqInt
	27, // 31: types.chain33.GenSeed:input_type -> types.GenSeedLang
	28, // 32: types.chain33.GetSeed:input_type -> types.GetSeedByPw
	29, // 33: types.chain33.SaveSeed:input_type -> types.SaveSeedByPw
	30, // 34: types.chain33.GetBalance:input_type -> types.ReqBalance
	31, // 35: types.chain33.QueryChain:input_type -> types.ChainExecutor
	31, // 36: types.chain33.ExecWallet:input_type -> types.ChainExecutor
	31, // 37: types.chain33.QueryConsensus:input_type -> types.ChainExecutor
	32, // 38: types.chain33.CreateTransaction:input_type -> types.CreateTxIn
	10, // 39: types.chain33.GetHexTxByHash:input_type -> types.ReqHash
	33, // 40: types.chain33.DumpPrivkey:input_type -> types.ReqString
	34, // 41: types.chain33.DumpPrivkeysFile:input_type -> types.ReqPrivkeysFile
	34, // 42: types.chain33.ImportPrivkeysFile:input_type -> types.ReqPrivkeysFile
	7,  // 43: types.chain33.Version:input_type -> types.ReqNil
	7,  // 44: types.chain33.IsSync:input_type -> types.ReqNil
	35, // 45: types.chain33.GetPeerInfo:input_type -> types.P2PGetPeerReq
	36, // 46: types.chain33.NetInfo:input_type -> types.P2PGetNetInfoReq
	7,  // 47: types.chain33.IsNtpClockSync:input_type -> types.ReqNil
	7,  // 48: types.chain33.GetFatalFailure:input_type -> types.ReqNil
	7,  // 49: types.chain33.GetLastBlockSequence:input_type -> types.ReqNil
	10, // 50: types.chain33.GetSequenceByHash:input_type -> types.ReqHash
	13, // 51: types.chain33.GetBlockByHashes:input_type -> types.ReqHashes
	37, // 52: types.chain33.GetBlockBySeq:input_type -> types.Int64
	7,  // 53: types.chain33.CloseQueue:input_type -> types.ReqNil
	38, // 54: types.chain33.GetAllExecBalance:input_type -> types.ReqAllExecBalance
	39, // 55: types.chain33.SignRawTx:input_type -> types.ReqSignRawTx
	40, // 56: types.chain33.CreateNoBalanceTransaction:input_type -> types.NoBalanceTx
	41, // 57: types.chain33.QueryRandNum:input_type -> types.ReqRandHash
	42, // 58: types.chain33.GetFork:input_type -> types.ReqKey
	43, // 59: types.chain33.CreateNoBalanceTxs:input_type -> types.NoBalanceTxs
	44, // 60: types.chain33.GetParaTxByTitle:input_type -> types.ReqParaTxByTitle
	45, // 61: types.chain33.LoadParaTxByTitle:input_type -> types.ReqHeightByTitle
	46, // 62: types.chain33.GetParaTxByHeight:input_type -> types.ReqParaTxByHeight
	6,  // 63: types.chain33.GetHeaders:input_type -> types.ReqBlocks
	7,  // 64: types.chain33.GetServerTime:input_type -> types.ReqNil
	7,  // 65: types.chain33.GetCryptoList:input_type -> types.ReqNil
	3,  // 66: types.chain33.SendDelayTransaction:input_type -> types.delayTx
	7,  // 67: types.chain33.GetChainConfig:input_type -> types.ReqNil
	47, // 68: types.chain33.GetBlocks:output_type -> types.Reply
	48, // 69: types.chain33.GetLastHeader:output_type -> types.Header
	49, // 70: types.chain33.CreateRawTransaction:output_type -> types.UnsignTx
	49, // 71: types.chain33.CreateRawTxGroup:output_type -> types.UnsignTx
	50, // 72: types.chain33.QueryTransaction:output_type -> types.TransactionDetail
	47, // 73: types.chain33.SendTransactionSync:output_type -> types.Reply
	47, // 74: types.chain33.SendTransaction:output_type -> types.Reply
	51, // 75: types.chain33.SendTransactions:output_type -> types.ReplyHashes
	52, // 76: types.chain33.GetTransactionByAddr:output_type -> types.ReplyTxInfos
	53, // 77: types.chain33.GetTransactionByHashes:output_type -> types.TransactionDetails
	54, // 78: types.chain33.GetMemPool:output_type -> types.ReplyTxList
	55, // 79: types.chain33.GetAccounts:output_type -> types.WalletAccounts
	56, // 80: types.chain33.GetAccount:output_type -> types.WalletAccount
	56, // 81: types.chain33.NewAccount:output_type -> types.WalletAccount
	57, // 82: types.chain33.WalletTransactionList:output_type -> types.WalletTxDetails
	56, // 83: types.chain33.ImportPrivkey:output_type -> types.WalletAccount
	58, // 84: types.chain33.SendToAddress:output_type -> types.ReplyHash
	47, // 85: types.chain33.SetTxFee:output_type -> types.Reply
	56, // 86: types.chain33.SetLabl:output_type -> types.WalletAccount
	51, // 87: types.chain33.MergeBalance:output_type -> types.ReplyHashes
	47, // 88: types.chain33.SetPasswd:output_type -> types.Reply
	47, // 89: types.chain33.Lock:output_type -> types.Reply
	47, // 90: types.chain33.UnLock:output_type -> types.Reply
	54, // 91: types.chain33.GetLastMemPool:output_type -> types.ReplyTxList
	59, // 92: types.chain33.GetProperFee:output_type -> types.ReplyProperFee
	60, // 93: types.chain33.GetWalletStatus:output_type -> types.WalletStatus
	61, // 94: types.chain33.GetBlockOverview:output_type -> types.BlockOverview
	62, // 95: types.chain33.GetAddrOverview:output_type -> types.AddrOverview
	58, // 96: types.chain33.GetBlockHash:output_type -> types.ReplyHash
	63, // 97: types.chain33.GenSeed:output_type -> types.ReplySeed
	63, // 98: types.chain33.GetSeed:output_type -> types.ReplySeed
	47, // 99: types.chain33.SaveSeed:output_type -> types.Reply
	64, // 100: types.chain33.GetBalance:output_type -> types.Accounts
	47, // 101: types.chain33.QueryChain:output_type -> types.Reply
	47, // 102: types.chain33.ExecWallet:output_type -> types.Reply
	47, // 103: types.chain33.QueryConsensus:output_type -> types.Reply
	49, // 104: types.chain33.CreateTransaction:output_type -> types.UnsignTx
	65, // 105: types.chain33.GetHexTxByHash:output_type -> types.HexTx
	66, // 106: types.chain33.DumpPrivkey:output_type -> types.ReplyString
	47, // 107: types.chain33.DumpPrivkeysFile:output_type -> types.Reply
	47, // 108: types.chain33.ImportPrivkeysFile:output_type -> types.Reply
	67, // 109: types.chain33.Version:output_type -> types.VersionInfo
	47, // 110: types.chain33.IsSync:output_type -> types.Reply
	68, // 111: types.chain33.GetPeerInfo:output_type -> types.PeerList
	69, // 112: types.chain33.NetInfo:output_type -> types.NodeNetInfo
	47, // 113: types.chain33.IsNtpClockSync:output_type -> types.Reply
	70, // 114: types.chain33.GetFatalFailure:output_type -> types.Int32
	37, // 115: types.chain33.GetLastBlockSequence:output_type -> types.Int64
	37, // 116: types.chain33.GetSequenceByHash:output_type -> types.Int64
	71, // 117: types.chain33.GetBlockByHashes:output_type -> types.BlockDetails
	72, // 118: types.chain33.GetBlockBySeq:output_type -> types.BlockSeq
	47, // 119: types.chain33.CloseQueue:output_type -> types.Reply
	73, // 120: types.chain33.GetAllExecBalance:output_type -> types.AllExecBalance
	74, // 121: types.chain33.SignRawTx:output_type -> types.ReplySignRawTx
	74, // 122: types.chain33.CreateNoBalanceTransaction:output_type -> types.ReplySignRawTx
	58, // 123: types.chain33.QueryRandNum:output_type -> types.ReplyHash
	37, // 124: types.chain33.GetFork:output_type -> types.Int64
	74, // 125: types.chain33.CreateNoBalanceTxs:output_type -> types.ReplySignRawTx
	75, // 126: types.chain33.GetParaTxByTitle:output_type -> types.ParaTxDetails
	76, // 127: types.chain33.LoadParaTxByTitle:output_type -> types.ReplyHeightByTitle
	75, // 128: types.chain33.GetParaTxByHeight:output_type -> types.ParaTxDetails
	77, // 129: types.chain33.GetHeaders:output_type -> types.Headers
	0,  // 130: types.chain33.GetServerTime:output_type -> types.serverTime
	2,  // 131: types.chain33.GetCryptoList:output_type -> types.cryptoList
	47, // 132: types.chain33.SendDelayTransaction:output_type -> types.Reply
	4,  // 133: types.chain33.GetChainConfig:output_type -> types.ChainConfigInfo
