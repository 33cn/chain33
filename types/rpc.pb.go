...
var file_rpc_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xdc, 0x1d, 0x0a, 0x07, 0x63, 0x68, 0x61,
	...
	0x79, 0x70, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0e,
	...
	0x67, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x00, 0x42, 0x1f, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*Replies)(nil),                  // 5: types.Replies
	(*Transaction)(nil),              // 6: types.Transaction
	(*Reply)(nil),                    // 7: types.Reply
	(*ReqBlocks)(nil),                // 8: types.ReqBlocks
	(*ReqNil)(nil),                   // 9: types.ReqNil
	(*CreateTx)(nil),                 // 10: types.CreateTx
	(*CreateTransactionGroup)(nil),   // 11: types.CreateTransactionGroup
	(*ReqHash)(nil),                  // 12: types.ReqHash
	(*Transactions)(nil),             // 13: types.Transactions
	(*ReqAddr)(nil),                  // 14: types.ReqAddr
	(*ReqHashes)(nil),                // 15: types.ReqHashes
	(*ReqGetMempool)(nil),            // 16: types.ReqGetMempool
	(*ReqGetAccount)(nil),            // 17: types.ReqGetAccount
	(*ReqNewAccount)(nil),            // 18: types.ReqNewAccount
	(*ReqWalletTransactionList)(nil), // 19: types.ReqWalletTransactionList
	(*ReqWalletImportPrivkey)(nil),   // 20: types.ReqWalletImportPrivkey
	(*ReqWalletSendToAddress)(nil),   // 21: types.ReqWalletSendToAddress
	(*ReqWalletSetFee)(nil),          // 22: types.ReqWalletSetFee
	(*ReqWalletSetLabel)(nil),        // 23: types.ReqWalletSetLabel
	(*ReqWalletMergeBalance)(nil),    // 24: types.ReqWalletMergeBalance
	(*ReqWalletSetPasswd)(nil),       // 25: types.ReqWalletSetPasswd
	(*WalletUnLock)(nil),             // 26: types.WalletUnLock
	(*ReqProperFee)(nil),             // 27: types.ReqProperFee
	(*ReqInt)(nil),                   // 28: types.ReqInt
	(*GenSeedLang)(nil),              // 29: types.GenSeedLang
	(*GetSeedByPw)(nil),              // 30: types.GetSeedByPw
	(*SaveSeedByPw)(nil),             // 31: types.SaveSeedByPw
	(*ReqBalance)(nil),               // 32: types.ReqBalance
	(*ChainExecutor)(nil),            // 33: types.ChainExecutor
	(*CreateTxIn)(nil),               // 34: types.CreateTxIn
	(*ReqString)(nil),                // 35: types.ReqString
	(*ReqPrivkeysFile)(nil),          // 36: types.ReqPrivkeysFile
	(*P2PGetPeerReq)(nil),            // 37: types.P2PGetPeerReq
	(*P2PGetNetInfoReq)(nil),         // 38: types.P2PGetNetInfoReq
	(*Int64)(nil),                    // 39: types.Int64
	(*ReqAllExecBalance)(nil),        // 40: types.ReqAllExecBalance
	(*ReqSignRawTx)(nil),             // 41: types.ReqSignRawTx
	(*NoBalanceTx)(nil),              // 42: types.NoBalanceTx
	(*ReqRandHash)(nil),              // 43: types.ReqRandHash
	(*ReqKey)(nil),                   // 44: types.ReqKey
	(*NoBalanceTxs)(nil),             // 45: types.NoBalanceTxs
	(*ReqParaTxByTitle)(nil),         // 46: types.ReqParaTxByTitle
	(*ReqHeightByTitle)(nil),         // 47: types.ReqHeightByTitle
	(*ReqParaTxByHeight)(nil),        // 48: types.ReqParaTxByHeight
	(*Header)(nil),                   // 49: types.Header
	(*UnsignTx)(nil),                 // 50: types.UnsignTx
	(*TransactionDetail)(nil),        // 51: types.TransactionDetail
	(*ReplyTxInfos)(nil),             // 52: types.ReplyTxInfos
	(*TransactionDetails)(nil),       // 53: types.TransactionDetails
	(*ReplyTxList)(nil),              // 54: types.ReplyTxList
	(*WalletAccounts)(nil),           // 55: types.WalletAccounts
	(*WalletAccount)(nil),            // 56: types.WalletAccount
	(*WalletTxDetails)(nil),          // 57: types.WalletTxDetails
	(*ReplyHash)(nil),                // 58: types.ReplyHash
	(*ReplyHashes)(nil),              // 59: types.ReplyHashes
	(*ReplyProperFee)(nil),           // 60: types.ReplyProperFee
	(*WalletStatus)(nil),             // 61: types.WalletStatus
	(*BlockOverview)(nil),            // 62: types.BlockOverview
	(*AddrOverview)(nil),             // 63: types.AddrOverview
	(*ReplySeed)(nil),                // 64: types.ReplySeed
	(*Accounts)(nil),                 // 65: types.Accounts
	(*HexTx)(nil),                    // 66: types.HexTx
	(*ReplyString)(nil),              // 67: types.ReplyString
	(*VersionInfo)(nil),              // 68: types.VersionInfo
	(*PeerList)(nil),                 // 69: types.PeerList
	(*NodeNetInfo)(nil),              // 70: types.NodeNetInfo
	(*Int32)(nil),                    // 71: types.Int32
	(*BlockDetails)(nil),             // 72: types.BlockDetails
	(*BlockSeq)(nil),                 // 73: types.BlockSeq
	(*AllExecBalance)(nil),           // 74: types.AllExecBalance
	(*ReplySignRawTx)(nil),           // 75: types.ReplySignRawTx
	(*ParaTxDetails)(nil),            // 76: types.ParaTxDetails
	(*ReplyHeightByTitle)(nil),       // 77: types.ReplyHeightByTitle
	(*Headers)(nil),                  // 78: types.Headers
}
var file_rpc_proto_depIdxs = []int32{
	1,  // 0: types.cryptoList.cryptos:type_name -> types.crypto
	6,  // 1: types.delayTx.tx:type_name -> types.Transaction
	7,  // 2: types.Replies.replyList:type_name -> types.Reply
	8,  // 3: types.chain33.GetBlocks:input_type -> types.ReqBlocks
	9,  // 4: types.chain33.GetLastHeader:input_type -> types.ReqNil
	10, // 5: types.chain33.CreateRawTransaction:input_type -> types.CreateTx
	11, // 6: types.chain33.CreateRawTxGroup:input_type -> types.CreateTransactionGroup
	12, // 7: types.chain33.QueryTransaction:input_type -> types.ReqHash
	6,  // 8: types.chain33.SendTransactionSync:input_type -> types.Transaction
	6,  // 9: types.chain33.SendTransaction:input_type -> types.Transaction
	13, // 10: types.chain33.SendTransactions:input_type -> types.Transactions
	14, // 11: types.chain33.GetTransactionByAddr:input_type -> types.ReqAddr
	15, // 12: types.chain33.GetTransactionByHashes:input_type -> types.ReqHashes
	16, // 13: types.chain33.GetMemPool:input_type -> types.ReqGetMempool
	9,  // 14: types.chain33.GetAccounts:input_type -> types.ReqNil
	17, // 15: types.chain33.GetAccount:input_type -> types.ReqGetAccount
	18, // 16: types.chain33.NewAccount:input_type -> types.ReqNewAccount
	19, // 17: types.chain33.WalletTransactionList:input_type -> types.ReqWalletTransactionList
	20, // 18: types.chain33.ImportPrivkey:input_type -> types.ReqWalletImportPrivkey
	21, // 19: types.chain33.SendToAddress:input_type -> types.ReqWalletSendToAddress
	22, // 20: types.chain33.SetTxFee:input_type -> types.ReqWalletSetFee
	23, // 21: types.chain33.SetLabl:input_type -> types.ReqWalletSetLabel
	24, // 22: types.chain33.MergeBalance:input_type -> types.ReqWalletMergeBalance
	25, // 23: types.chain33.SetPasswd:input_type -> types.ReqWalletSetPasswd
	9,  // 24: types.chain33.Lock:input_type -> types.ReqNil
	26, // 25: types.chain33.UnLock:input_type -> types.WalletUnLock
	9,  // 26: types.chain33.GetLastMemPool:input_type -> types.ReqNil
	27, // 27: types.chain33.GetProperFee:input_type -> types.ReqProperFee
	9,  // 28: types.chain33.GetWalletStatus:input_type -> types.ReqNil
	12, // 29: types.chain33.GetBlockOverview:input_type -> types.ReqHash
	14, // 30: types.chain33.GetAddrOverview:input_type -> types.ReqAddr
	28, // 31: types.chain33.GetBlockHash:input_type -> types.ReqInt
	29, // 32: types.chain33.GenSeed:input_type -> types.GenSeedLang
	30, // 33: types.chain33.GetSeed:input_type -> types.GetSeedByPw
	31, // 34: types.chain33.SaveSeed:input_type -> types.SaveSeedByPw
	32, // 35: types.chain33.GetBalance:input_type -> types.ReqBalance
	33, // 36: types.chain33.QueryChain:input_type -> types.ChainExecutor
	33, // 37: types.chain33.ExecWallet:input_type -> types.ChainExecutor
	33, // 38: types.chain33.QueryConsensus:input_type -> types.ChainExecutor
	34, // 39: types.chain33.CreateTransaction:input_type -> types.CreateTxIn
	12, // 40: types.chain33.GetHexTxByHash:input_type -> types.ReqHash
	35, // 41: types.chain33.DumpPrivkey:input_type -> types.ReqString
	36, // 42: types.chain33.DumpPrivkeysFile:input_type -> types.ReqPrivkeysFile
	36, // 43: types.chain33.ImportPrivkeysFile:input_type -> types.ReqPrivkeysFile
	9,  // 44: types.chain33.Version:input_type -> types.ReqNil
	9,  // 45: types.chain33.IsSync:input_type -> types.ReqNil
	37, // 46: types.chain33.GetPeerInfo:input_type -> types.P2PGetPeerReq
	38, // 47: types.chain33.NetInfo:input_type -> types.P2PGetNetInfoReq
	9,  // 48: types.chain33.IsNtpClockSync:input_type -> types.ReqNil
	9,  // 49: types.chain33.GetFatalFailure:input_type -> types.ReqNil
	9,  // 50: types.chain33.GetLastBlockSequence:input_type -> types.ReqNil
	12, // 51: types.chain33.GetSequenceByHash:input_type -> types.ReqHash
	15, // 52: types.chain33.GetBlockByHashes:input_type -> types.ReqHashes
	39, // 53: types.chain33.GetBlockBySeq:input_type -> types.Int64
	9,  // 54: types.chain33.CloseQueue:input_type -> types.ReqNil
	40, // 55: types.chain33.GetAllExecBalance:input_type -> types.ReqAllExecBalance
	41, // 56: types.chain33.SignRawTx:input_type -> types.ReqSignRawTx
	42, // 57: types.chain33.CreateNoBalanceTransaction:input_type -> types.NoBalanceTx
	43, // 58: types.chain33.QueryRandNum:input_type -> types.ReqRandHash
	44, // 59: types.chain33.GetFork:input_type -> types.ReqKey
	45, // 60: types.chain33.CreateNoBalanceTxs:input_type -> types.NoBalanceTxs
	46, // 61: types.chain33.GetParaTxByTitle:input_type -> types.ReqParaTxByTitle
	47, // 62: types.chain33.LoadParaTxByTitle:input_type -> types.ReqHeightByTitle
	48, // 63: types.chain33.GetParaTxByHeight:input_type -> types.ReqParaTxByHeight
	8,  // 64: types.chain33.GetHeaders:input_type -> types.ReqBlocks
	9,  // 65: types.chain33.GetServerTime:input_type -> types.ReqNil
	9,  // 66: types.chain33.GetCryptoList:input_type -> types.ReqNil
	3,  // 67: types.chain33.SendDelayTransaction:input_type -> types.delayTx
	9,  // 68: types.chain33.GetChainConfig:input_type -> types.ReqNil
	7,  // 69: types.chain33.GetBlocks:output_type -> types.Reply
	49, // 70: types.chain33.GetLastHeader:output_type -> types.Header
	50, // 71: types.chain33.CreateRawTransaction:output_type -> types.UnsignTx
	50, // 72: types.chain33.CreateRawTxGroup:output_type -> types.UnsignTx
	51, // 73: types.chain33.QueryTransaction:output_type -> types.TransactionDetail
	7,  // 74: types.chain33.SendTransactionSync:output_type -> types.Reply
	7,  // 75: types.chain33.SendTransaction:output_type -> types.Reply
	5,  // 76: types.chain33.SendTransactions:output_type -> types.Replies
	52, // 77: types.chain33.GetTransactionByAddr:output_type -> types.ReplyTxInfos
	53, // 78: types.chain33.GetTransactionByHashes:output_type -> types.TransactionDetails
	54, // 79: types.chain33.GetMemPool:output_type -> types.ReplyTxList
	55, // 80: types.chain33.GetAccounts:output_type -> types.WalletAccounts
	56, // 81: types.chain33.GetAccount:output_type -> types.WalletAccount
	56, // 82: types.chain33.NewAccount:output_type -> types.WalletAccount
	57, // 83: types.chain33.WalletTransactionList:output_type -> types.WalletTxDetails
	56, // 84: types.chain33.ImportPrivkey:output_type -> types.WalletAccount
	58, // 85: types.chain33.SendToAddress:output_type -> types.ReplyHash
	7,  // 86: types.chain33.SetTxFee:output_type -> types.Reply
	56, // 87: types.chain33.SetLabl:output_type -> types.WalletAccount
	59, // 88: types.chain33.MergeBalance:output_type -> types.ReplyHashes
	7,  // 89: types.chain33.SetPasswd:output_type -> types.Reply
	7,  // 90: types.chain33.Lock:output_type -> types.Reply
	7,  // 91: types.chain33.UnLock:output_type -> types.Reply
	54, // 92: types.chain33.GetLastMemPool:output_type -> types.ReplyTxList
	60, // 93: types.chain33.GetProperFee:output_type -> types.ReplyProperFee
	61, // 94: types.chain33.GetWalletStatus:output_type -> types.WalletStatus
	62, // 95: types.chain33.GetBlockOverview:output_type -> types.BlockOverview
	63, // 96: types.chain33.GetAddrOverview:output_type -> types.AddrOverview
	58, // 97: types.chain33.GetBlockHash:output_type -> types.ReplyHash
	64, // 98: types.chain33.GenSeed:output_type -> types.ReplySeed
	64, // 99: types.chain33.GetSeed:output_type -> types.ReplySeed
	7,  // 100: types.chain33.SaveSeed:output_type -> types.Reply
	65, // 101: types.chain33.GetBalance:output_type -> types.Accounts
	7,  // 102: types.chain33.QueryChain:output_type -> types.Reply
	7,  // 103: types.chain33.ExecWallet:output_type -> types.Reply
	7,  // 104: types.chain33.QueryConsensus:output_type -> types.Reply
	50, // 105: types.chain33.CreateTransaction:output_type -> types.UnsignTx
	66, // 106: types.chain33.GetHexTxByHash:output_type -> types.HexTx
	67, // 107: types.chain33.DumpPrivkey:output_type -> types.ReplyString
	7,  // 108: types.chain33.DumpPrivkeysFile:output_type -> types.Reply
	7,  // 109: types.chain33.ImportPrivkeysFile:output_type -> types.Reply
	68, // 110: types.chain33.Version:output_type -> types.VersionInfo
	7,  // 111: types.chain33.IsSync:output_type -> types.Reply
	69, // 112: types.chain33.GetPeerInfo:output_type -> types.PeerList
	70, // 113: types.chain33.NetInfo:output_type -> types.NodeNetInfo
	7,  // 114: types.chain33.IsNtpClockSync:output_type -> types.Reply
	71, // 115: types.chain33.GetFatalFailure:output_type -> types.Int32
	39, // 116: types.chain33.GetLastBlockSequence:output_type -> types.Int64
	39, // 117: types.chain33.GetSequenceByHash:output_type -> types.Int64
	72, // 118: types.chain33.GetBlockByHashes:output_type -> types.BlockDetails
	73, // 119: types.chain33.GetBlockBySeq:output_type -> types.BlockSeq
	7,  // 120: types.chain33.CloseQueue:output_type -> types.Reply
	74, // 121: types.chain33.GetAllExecBalance:output_type -> types.AllExecBalance
	75, // 122: types.chain33.SignRawTx:output_type -> types.ReplySignRawTx
	75, // 123: types.chain33.CreateNoBalanceTransaction:output_type -> types.ReplySignRawTx
	58, // 124: types.chain33.QueryRandNum:output_type -> types.ReplyHash
	39, // 125: types.chain33.GetFork:output_type -> types.Int64
	75, // 126: types.chain33.CreateNoBalanceTxs:output_type -> types.ReplySignRawTx
	76, // 127: types.chain33.GetParaTxByTitle:output_type -> types.ParaTxDetails
	77, // 128: types.chain33.LoadParaTxByTitle:output_type -> types.ReplyHeightByTitle
	76, // 129: types.chain33.GetParaTxByHeight:output_type -> types.ParaTxDetails
	78, // 130: types.chain33.GetHeaders:output_type -> types.Headers
	0,  // 131: types.chain33.GetServerTime:output_type -> types.serverTime
	2,  // 132: types.chain33.GetCryptoList:output_type -> types.cryptoList
	7,  // 133: types.chain33.SendDelayTransaction:output_type -> types.Reply
	4,  // 134: types.chain33.GetChainConfig:output_type -> types.ChainConfigInfo
	69, // [69:135] is the sub-list for method output_type
	3,  // [3:69] is the sub-list for method input_type
