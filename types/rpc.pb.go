...
type Chain33Client interface {
	...
	// 通过block seq 获取对应的blocks hash 信息
	GetForwardDelBlock(ctx context.Context, in *BlockSeq, opts ...grpc.CallOption) (*BlockSeq, error)
	// 关闭chain33
...
func (c *chain33Client) GetForwardDelBlock(ctx context.Context, in *BlockSeq, opts ...grpc.CallOption) (*BlockSeq, error) {
	out := new(BlockSeq)
	err := c.cc.Invoke(ctx, "/types.chain33/GetForwardDelBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type Chain33Server interface {
	...
	// 通过block seq 获取对应的blocks hash 信息
	GetForwardDelBlock(context.Context, *BlockSeq) (*BlockSeq, error)
	// 关闭chain33
...
func _Chain33_GetForwardDelBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlockSeq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Chain33Server).GetForwardDelBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.chain33/GetForwardDelBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Chain33Server).GetForwardDelBlock(ctx, req.(*BlockSeq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Chain33_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetForwardDelBlock",
			Handler:    _Chain33_GetForwardDelBlock_Handler,
		},
		{
...
func init() { proto.RegisterFile("rpc.proto", fileDescriptor_rpc_15054eed8600d10b) }

var fileDescriptor_rpc_15054eed8600d10b = []byte{
	...
	,
}
