...
var file_p2pnext_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x09, 0x72, 0x61, 0x74, 0x65, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x1f, 0x5a, 0x1d,
...
var file_p2pnext_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_p2pnext_proto_goTypes = []interface{}{
	...
	(*P2PPeerInfo)(nil),            // 45: types.P2PPeerInfo
	(*P2PVersion)(nil),             // 46: types.P2PVersion
	(*P2PVerAck)(nil),              // 47: types.P2PVerAck
	(*P2PExternalInfo)(nil),        // 48: types.P2PExternalInfo
	(*P2PGetBlocks)(nil),           // 49: types.P2PGetBlocks
	(*InvDatas)(nil),               // 50: types.InvDatas
	(*P2PPing)(nil),                // 51: types.P2PPing
	(*P2PPong)(nil),                // 52: types.P2PPong
	(*P2PGetAddr)(nil),             // 53: types.P2PGetAddr
	(*P2PAddr)(nil),                // 54: types.P2PAddr
	(*P2PAddrList)(nil),            // 55: types.P2PAddrList
	(*P2PGetMempool)(nil),          // 56: types.P2PGetMempool
	(*Versions)(nil),               // 57: types.Versions
	(*P2PGetHeaders)(nil),          // 58: types.P2PGetHeaders
	(*P2PHeaders)(nil),             // 59: types.P2PHeaders
	(*InvData)(nil),                // 60: types.InvData
	(*PeerList)(nil),               // 61: types.PeerList
	(*NodeNetInfo)(nil),            // 62: types.NodeNetInfo
	(*PeersReply)(nil),             // 63: types.PeersReply
	(*BroadCastData)(nil),          // 64: types.BroadCastData
	(*ReqChunkRecords)(nil),        // 65: types.ReqChunkRecords
	(*ChunkInfoMsg)(nil),           // 66: types.ChunkInfoMsg
	(*ReqBlocks)(nil),              // 67: types.ReqBlocks
	(*BlockBody)(nil),              // 68: types.BlockBody
	(*Headers)(nil),                // 69: types.Headers
	(*ChunkRecords)(nil),           // 70: types.ChunkRecords
}
var file_p2pnext_proto_depIdxs = []int32{
	0,  // 0: types.MessageUtil.common:type_name -> types.MessageComm
	45, // 1: types.MessageUtil.peerInfo:type_name -> types.P2PPeerInfo
	46, // 2: types.MessageUtil.version:type_name -> types.P2PVersion
	47, // 3: types.MessageUtil.versionAck:type_name -> types.P2PVerAck
	48, // 4: types.MessageUtil.external:type_name -> types.P2PExternalInfo
	49, // 5: types.MessageUtil.getblocks:type_name -> types.P2PGetBlocks
	50, // 6: types.MessageUtil.invdatas:type_name -> types.InvDatas
	...
	45, // 9: types.MessagePeerInfoResp.message:type_name -> types.P2PPeerInfo
	0,  // 10: types.MessageP2PVersionReq.messageData:type_name -> types.MessageComm
	46, // 11: types.MessageP2PVersionReq.message:type_name -> types.P2PVersion
	0,  // 12: types.MessageP2PVersionResp.messageData:type_name -> types.MessageComm
	46, // 13: types.MessageP2PVersionResp.message:type_name -> types.P2PVersion
	0,  // 14: types.MessagePingReq.messageData:type_name -> types.MessageComm
	51, // 15: types.MessagePingReq.message:type_name -> types.P2PPing
	0,  // 16: types.MessagePingResp.messageData:type_name -> types.MessageComm
	52, // 17: types.MessagePingResp.message:type_name -> types.P2PPong
	0,  // 18: types.MessageAddrReq.messageData:type_name -> types.MessageComm
	53, // 19: types.MessageAddrReq.message:type_name -> types.P2PGetAddr
	0,  // 20: types.MessageAddrResp.messageData:type_name -> types.MessageComm
	54, // 21: types.MessageAddrResp.message:type_name -> types.P2PAddr
	0,  // 22: types.MessageAddrList.messageData:type_name -> types.MessageComm
	55, // 23: types.MessageAddrList.message:type_name -> types.P2PAddrList
	...
	48, // 26: types.MessageExternalNetResp.message:type_name -> types.P2PExternalInfo
	0,  // 27: types.MessageGetBlocksReq.messageData:type_name -> types.MessageComm
	49, // 28: types.MessageGetBlocksReq.message:type_name -> types.P2PGetBlocks
	0,  // 29: types.MessageGetBlocksResp.messageData:type_name -> types.MessageComm
	50, // 30: types.MessageGetBlocksResp.message:type_name -> types.InvDatas
	0,  // 31: types.MessageGetMempoolReq.messageData:type_name -> types.MessageComm
	56, // 32: types.MessageGetMempoolReq.message:type_name -> types.P2PGetMempool
	0,  // 33: types.MessageVersion.messageData:type_name -> types.MessageComm
	57, // 34: types.MessageVersion.message:type_name -> types.Versions
	0,  // 35: types.MessageHeaderReq.messageData:type_name -> types.MessageComm
	58, // 36: types.MessageHeaderReq.message:type_name -> types.P2PGetHeaders
	0,  // 37: types.MessageHeaderResp.messageData:type_name -> types.MessageComm
	59, // 38: types.MessageHeaderResp.message:type_name -> types.P2PHeaders
	0,  // 39: types.MessageInvDataReq.messageData:type_name -> types.MessageComm
	60, // 40: types.MessageInvDataReq.message:type_name -> types.InvData
	0,  // 41: types.MessagePeerList.messageData:type_name -> types.MessageComm
	61, // 42: types.MessagePeerList.message:type_name -> types.PeerList
	0,  // 43: types.MessageNetInfo.messageData:type_name -> types.MessageComm
	62, // 44: types.MessageNetInfo.message:type_name -> types.NodeNetInfo
	0,  // 45: types.MessagePeersReply.common:type_name -> types.MessageComm
	63, // 46: types.MessagePeersReply.peersReply:type_name -> types.PeersReply
	0,  // 47: types.MessageBroadCast.common:type_name -> types.MessageComm
	64, // 48: types.MessageBroadCast.message:type_name -> types.BroadCastData
	24, // 49: types.P2PRequest.headers:type_name -> types.P2PMessageHeaders
	65, // 50: types.P2PRequest.reqChunkRecords:type_name -> types.ReqChunkRecords
	66, // 51: types.P2PRequest.chunkInfoMsg:type_name -> types.ChunkInfoMsg
	28, // 52: types.P2PRequest.chunkInfoList:type_name -> types.ChunkInfoList
	67, // 53: types.P2PRequest.reqBlocks:type_name -> types.ReqBlocks
	...
	66, // 57: types.ChunkInfoList.items:type_name -> types.ChunkInfoMsg
	...
	68, // 60: types.P2PResponse.blockBody:type_name -> types.BlockBody
	69, // 61: types.P2PResponse.blockHeaders:type_name -> types.Headers
	70, // 62: types.P2PResponse.chunkRecords:type_name -> types.ChunkRecords
