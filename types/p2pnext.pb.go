...
type MessagePeerInfoResp struct {
	MessageData *MessageComm `protobuf:"bytes,1,opt,name=messageData,proto3" json:"messageData,omitempty"`
	// Types that are valid to be assigned to Value:
	//	*MessagePeerInfoResp_Message
	//	*MessagePeerInfoResp_PeerInfo
	Value                isMessagePeerInfoResp_Value `protobuf_oneof:"value"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
type isMessagePeerInfoResp_Value interface {
	isMessagePeerInfoResp_Value()
}

type MessagePeerInfoResp_Message struct {
	Message *P2PPeerInfo `protobuf:"bytes,2,opt,name=message,proto3,oneof"`
}

type MessagePeerInfoResp_PeerInfo struct {
	PeerInfo *P2PPeerInfoV2 `protobuf:"bytes,3,opt,name=peerInfo,proto3,oneof"`
}

func (*MessagePeerInfoResp_Message) isMessagePeerInfoResp_Value() {}

func (*MessagePeerInfoResp_PeerInfo) isMessagePeerInfoResp_Value() {}

func (m *MessagePeerInfoResp) GetValue() isMessagePeerInfoResp_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *MessagePeerInfoResp) GetMessage() *P2PPeerInfo {
	if x, ok := m.GetValue().(*MessagePeerInfoResp_Message); ok {
		return x.Message
	}
	return nil
}

func (m *MessagePeerInfoResp) GetPeerInfo() *P2PPeerInfoV2 {
	if x, ok := m.GetValue().(*MessagePeerInfoResp_PeerInfo); ok {
		return x.PeerInfo
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*MessagePeerInfoResp) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MessagePeerInfoResp_Message)(nil),
		(*MessagePeerInfoResp_PeerInfo)(nil),
	}
}
...
var fileDescriptor_d81e96199caf00d1 = []byte{
	...
	,
}
