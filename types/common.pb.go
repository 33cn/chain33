...
type ReqForkData struct {
	Height               int64    `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	ForkKey              string   `protobuf:"bytes,2,opt,name=forkKey,proto3" json:"forkKey,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *ReqForkData) Reset()         { *m = ReqForkData{} }
func (m *ReqForkData) String() string { return proto.CompactTextString(m) }
func (*ReqForkData) ProtoMessage()    {}
func (*ReqForkData) Descriptor() ([]byte, []int) {
	return fileDescriptor_555bd8c177793206, []int{17}
}

func (m *ReqForkData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ReqForkData.Unmarshal(m, b)
}
func (m *ReqForkData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ReqForkData.Marshal(b, m, deterministic)
}
func (m *ReqForkData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReqForkData.Merge(m, src)
}
func (m *ReqForkData) XXX_Size() int {
	return xxx_messageInfo_ReqForkData.Size(m)
}
func (m *ReqForkData) XXX_DiscardUnknown() {
	xxx_messageInfo_ReqForkData.DiscardUnknown(m)
}

var xxx_messageInfo_ReqForkData proto.InternalMessageInfo

func (m *ReqForkData) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *ReqForkData) GetForkKey() string {
	if m != nil {
		return m.ForkKey
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ReqForkData)(nil), "types.ReqForkData")
}
...
var fileDescriptor_555bd8c177793206 = []byte{
	...
	,
}
