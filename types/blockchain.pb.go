...
func (*BlockSequence) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{19} }
...
func (*BlockSequences) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{20} }
...
func (*ParaChainBlockDetail) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{21} }
...
var fileDescriptor1 = []byte{
	...
	,
}
