...
func (*LocalDBSetWithPrivacy) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{12} }
...
func (*ReceiptsAndPrivacyKV) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{13} }
...
func (*IsCaughtUp) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{20} }
...
func (*IsNtpClockSync) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{21} }
...
func (*BlockChainQuery) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }
...
var fileDescriptor1 = []byte{
	...
	,
}
