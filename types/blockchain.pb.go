...
func (m *ReqChunkBlock) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReqChunkBlock.Merge(m, src)
}
...
func (m *ReqChunkBlockBody) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReqChunkBlockBody.Merge(m, src)
}
...
func (*ReqChunkRecords) Descriptor() ([]byte, []int) {
	return fileDescriptor_e9ac6287ce250c9a, []int{50}
}
