...
func (m *ReplyParaTxByHeight) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReplyParaTxByHeight.Merge(m, src)
}
...
func (m *ParaTxInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParaTxInfo.Merge(m, src)
}
