...
func (*Operation) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*Checkpoint) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func (*Entry) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }
...
func (*ViewChange) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }
...
func (*Summary) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{4} }
...
func (*Result) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{5} }
...
func (*Request) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{6} }
...
func (*RequestClient) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{7} }
...
func (*RequestPrePrepare) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{8} }
...
func (*RequestPrepare) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{9} }
...
func (*RequestCommit) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{10} }
...
func (*RequestCheckpoint) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{11} }
...
func (*RequestViewChange) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{12} }
...
func (*RequestAck) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{13} }
...
func (*RequestNewView) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{14} }
...
func (*ClientReply) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{15} }
...
func init() { proto.RegisterFile("pbft.proto", fileDescriptor13) }
