...
func (*ReqAuthSignTx) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{32} }
...
func (*ReplyAuthSignTx) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{33} }
...
var fileDescriptor10 = []byte{
	...
	,
}
