...
type NotifySendTxResult struct {
...
func (m *NotifySendTxResult) Reset()                    { *m = NotifySendTxResult{} }
func (m *NotifySendTxResult) String() string            { return proto.CompactTextString(m) }
func (*NotifySendTxResult) ProtoMessage()               {}
func (*NotifySendTxResult) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{64} }

func (m *NotifySendTxResult) GetIsok() bool {
	if m != nil {
		return m.Isok
	}
	return false
...
func (m *NotifySendTxResult) GetTx() *Transaction {
	if m != nil {
		return m.Tx
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*NotifySendTxResult)(nil), "types.NotifySendTxResult")
}
...
var fileDescriptor15 = []byte{
	...
	0xef, 0xea, 0x3e, 0xaf, 0xbc, 0xca, 0x56, 0x96, 0x2c, 0xbf, 0xca, 0xbe, 0x86, 0xf0, 0x4d, 0xa6,
	0xe5, 0xf1, 0x9c, 0x9e, 0x02, 0x67, 0x5c, 0xe4, 0x45, 0x42, 0x5b, 0x2c, 0xf3, 0xcc, 0xfd, 0x2f,
	0x40, 0xdf, 0xf6, 0xcf, 0xb1, 0xc6, 0xbb, 0xfe, 0x1c, 0x1b, 0xae, 0xd2, 0x5f, 0x6b, 0x8f, 0xff,
	0x13, 0x00, 0x00, 0xff, 0xff, 0x98, 0xa4, 0xcf, 0x46, 0xca, 0x1b, 0x00, 0x00,
}
