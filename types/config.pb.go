...
type Rpc struct {
	...
	RemoteIpWhitelist []string `protobuf:"bytes,3,rep,name=remoteIpWhitelist" json:"remoteIpWhitelist,omitempty"`
...
func (m *Rpc) GetRemoteIpWhitelist() []string {
	if m != nil {
		return m.RemoteIpWhitelist
	}
	return nil
}
...
var fileDescriptor3 = []byte{
	...
	,
}
