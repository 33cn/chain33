...
type Authority struct {
	...
	SecurityLevel int32  `protobuf:"varint,3,opt,name=securityLevel" json:"securityLevel,omitempty"`
	HashAlgorithm string `protobuf:"bytes,4,opt,name=hashAlgorithm" json:"hashAlgorithm,omitempty"`
	SignType      int32  `protobuf:"varint,5,opt,name=signType" json:"signType,omitempty"`
	OrgName       string `protobuf:"bytes,6,opt,name=orgName" json:"orgName,omitempty"`
}
...
var fileDescriptor3 = []byte{
	...
	,
}
