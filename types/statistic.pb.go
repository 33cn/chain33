...
func (*TotalFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{0}
}
...
func (*ReqGetTotalCoins) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{1}
}
...
func (*ReplyGetTotalCoins) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{2}
}
...
func (*IterateRangeByStateHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{3}
}
...
func (*TotalAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{4}
}
...
func (*ReqGetExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{5}
}
...
func (*ExecBalanceItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{6}
}
...
func (*ReplyGetExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_db49ff7314d17334, []int{7}
}
...
func init() { proto.RegisterFile("statistic.proto", fileDescriptor_statistic_db49ff7314d17334) }

var fileDescriptor_statistic_db49ff7314d17334 = []byte{
