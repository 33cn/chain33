...
func (*TotalFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{0}
}
...
func (*ReqGetTotalCoins) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{1}
}
...
func (*ReplyGetTotalCoins) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{2}
}
...
func (*IterateRangeByStateHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{3}
}
...
func (*TotalAmount) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{4}
}
...
func (*ReqGetExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{5}
}
...
func (*ExecBalanceItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{6}
}
...
func (*ReplyGetExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_statistic_ea86e01285e2f77a, []int{7}
}
...
func init() { proto.RegisterFile("statistic.proto", fileDescriptor_statistic_ea86e01285e2f77a) }

var fileDescriptor_statistic_ea86e01285e2f77a = []byte{
