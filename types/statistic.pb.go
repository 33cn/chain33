...
func (*TotalFee) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0} }
...
func (*ReqGetTotalCoins) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{1} }
...
func (*ReplyGetTotalCoins) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{2} }
...
func (*IterateRangeByStateHash) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{3} }
...
func (*TicketStatistic) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{4} }
...
func (*TicketMinerInfo) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{5} }
...
func init() { proto.RegisterFile("statistic.proto", fileDescriptor16) }
