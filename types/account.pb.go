...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{0}
}
...
func (*ReceiptExecAccountTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{1}
}
...
func (*ReceiptAccountTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{2}
}
...
func (*ReqBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{3}
}
...
func (*Accounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{4}
}
...
func (*ExecAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{5}
}
...
func (*AllExecBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_ba00ba5df64ea6cb, []int{6}
}
...
func init() { proto.RegisterFile("account.proto", fileDescriptor_account_ba00ba5df64ea6cb) }

var fileDescriptor_account_ba00ba5df64ea6cb = []byte{
