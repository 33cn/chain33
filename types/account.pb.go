...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{0}
}
...
func (*ReceiptExecAccountTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{1}
}
...
func (*ReceiptAccountTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{2}
}
...
func (*ReqBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{3}
}
...
func (*Accounts) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{4}
}
...
func (*ReqTokenBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{5}
}
...
func (*ReqAccountTokenAssets) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{6}
}
...
func (*TokenAsset) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{7}
}
...
func (*ReplyAccountTokenAssets) Descriptor() ([]byte, []int) {
	return fileDescriptor_account_7150956a24e743cd, []int{8}
}
...
func init() { proto.RegisterFile("account.proto", fileDescriptor_account_7150956a24e743cd) }

var fileDescriptor_account_7150956a24e743cd = []byte{
