...
type P2P struct {
	...
	// 交易开始采用哈希广播的ttl
	StartLightTxTTL int32 `protobuf:"varint,18,opt,name=innerBounds" json:"startLightTxTTL,omitempty"`
	// 最大传播ttl, ttl达到该值将停止继续向外发送
	MaxTTL int32 `protobuf:"varint,19,opt,name=innerBounds" json:"maxTTL,omitempty"`
}
