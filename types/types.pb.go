...
func (*InvData) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{63} }
...
func (*InvDatas) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{64} }
...
func (*Genesis) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{65} }
...
func (*WalletAccounts) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{66} }
...
func (*ReqNewAccount) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{67} }
...
func (*ReqWalletTransactionList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{68} }
...
func (*ReqWalletImportPrivKey) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{69} }
...
func (*ReqWalletSendToAddress) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70} }
...
func (*ReqWalletSetFee) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{71} }
...
func (*ReqWalletSetLabel) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{72} }
...
func (*ReqWalletMergeBalance) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{73} }
...
func (*ReplyHashes) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{74} }
...
func (*ReqWalletSetPasswd) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{75} }
...
func (*WalletUnLock) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{76} }
...
func (*Config) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{77} }
...
func (*P2P) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{78} }
...
func (*Wallet) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{79} }
...
func (*Store) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{80} }
...
func (*Consensus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{81} }
...
func (*MemPool) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{82} }
...
func (*BlockChain) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{83} }
...
func (*ReplyTxInfos) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{84} }
...
func (*WalletTxDetail) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{85} }
...
func (*WalletTxDetails) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{86} }
...
func (*WalletAccountStore) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{87} }
...
func (*Blocks) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{88} }
...
func (*WalletPwHash) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{89} }
...
func (*CoinsAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{90} }
...
func (*CoinsGenesis) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{91} }
...
func (*CoinsTransfer) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{92} }
...
func (*TicketAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{93} }
...
type TicketAction_Tlist struct {
	Tlist *TicketList `protobuf:"bytes,4,opt,name=tlist,oneof"`
}
type TicketAction_Infos struct {
	Infos *TicketInfos `protobuf:"bytes,5,opt,name=infos,oneof"`
}
...
func (*TicketAction_Tlist) isTicketAction_Value()   {}
func (*TicketAction_Infos) isTicketAction_Value()   {}
...
func (m *TicketAction) GetTlist() *TicketList {
	if x, ok := m.GetValue().(*TicketAction_Tlist); ok {
		return x.Tlist
	}
	return nil
}

func (m *TicketAction) GetInfos() *TicketInfos {
	if x, ok := m.GetValue().(*TicketAction_Infos); ok {
		return x.Infos
	}
	return nil
}
...
func (*TicketAction) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TicketAction_OneofMarshaler, _TicketAction_OneofUnmarshaler, _TicketAction_OneofSizer, []interface{}{
		...
		(*TicketAction_Tlist)(nil),
		(*TicketAction_Infos)(nil),
	}
}
...
func _TicketAction_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *TicketAction_Tlist:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Tlist); err != nil {
			return err
		}
	case *TicketAction_Infos:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Infos); err != nil {
			return err
		}
	case nil:
	default:
...
func _TicketAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // value.tlist
		...
		msg := new(TicketList)
		err := b.DecodeMessage(msg)
		m.Value = &TicketAction_Tlist{msg}
		return true, err
	case 5: // value.infos
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(TicketInfos)
		err := b.DecodeMessage(msg)
		m.Value = &TicketAction_Infos{msg}
		return true, err
	default:
		return false, nil
	}
...
func _TicketAction_OneofSizer(msg proto.Message) (n int) {
	...
	case *TicketAction_Tclose:
		...
		n += s
	case *TicketAction_Tlist:
		s := proto.Size(x.Tlist)
		n += proto.SizeVarint(4<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *TicketAction_Infos:
		s := proto.Size(x.Infos)
...
func (*TicketOpen) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{94} }
...
type TicketGenesis struct {
	MinerAddress string `protobuf:"bytes,1,opt,name=minerAddress" json:"minerAddress,omitempty"`
	CodeWallet   string `protobuf:"bytes,2,opt,name=codeWallet" json:"codeWallet,omitempty"`
...
func (*TicketGenesis) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{95} }
...
func (m *TicketGenesis) GetCodeWallet() string {
	if m != nil {
		return m.CodeWallet
	}
	return ""
...
func (*TicketClose) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{96} }
...
func (*TicketList) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{97} }
...
func (*TicketInfos) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{98} }
...
type Ticket struct {
	...
	ReturnWallet string `protobuf:"bytes,7,opt,name=returnWallet" json:"returnWallet,omitempty"`
}

func (m *Ticket) Reset()                    { *m = Ticket{} }
func (m *Ticket) String() string            { return proto.CompactTextString(m) }
func (*Ticket) ProtoMessage()               {}
func (*Ticket) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{99} }
...
func (m *Ticket) GetReturnWallet() string {
	if m != nil {
		return m.ReturnWallet
	}
	return ""
}

type NewTicketReceipt struct {
	TicketId string `protobuf:"bytes,1,opt,name=ticketId" json:"ticketId,omitempty"`
}

func (m *NewTicketReceipt) Reset()                    { *m = NewTicketReceipt{} }
func (m *NewTicketReceipt) String() string            { return proto.CompactTextString(m) }
func (*NewTicketReceipt) ProtoMessage()               {}
func (*NewTicketReceipt) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{100} }

func (m *NewTicketReceipt) GetTicketId() string {
	if m != nil {
		return m.TicketId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*NewTicketReceipt)(nil), "types.NewTicketReceipt")
}
...
var fileDescriptor0 = []byte{
	...
	,
}
