...
func (*LeafNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*InnerNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*StoreNode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*MAVLProof) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
var fileDescriptor0 = []byte{
	...
	,
}
