...
type RelaySaveBTCHeadFlag int32

const (
	RelaySaveBTCHeadFlag_normalSave RelaySaveBTCHeadFlag = 0
	RelaySaveBTCHeadFlag_resetHead  RelaySaveBTCHeadFlag = 1
)

var RelaySaveBTCHeadFlag_name = map[int32]string{
	0: "normalSave",
	1: "resetHead",
}
var RelaySaveBTCHeadFlag_value = map[string]int32{
	"normalSave": 0,
	"resetHead":  1,
}

func (x RelaySaveBTCHeadFlag) String() string {
	return proto.EnumName(RelaySaveBTCHeadFlag_name, int32(x))
}
func (RelaySaveBTCHeadFlag) EnumDescriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
type BtcHeader struct {
	...
	Flag          RelaySaveBTCHeadFlag `protobuf:"varint,12,opt,name=flag,enum=types.RelaySaveBTCHeadFlag" json:"flag,omitempty"`
}
...
func (m *BtcHeader) GetFlag() RelaySaveBTCHeadFlag {
	if m != nil {
		return m.Flag
	}
	return RelaySaveBTCHeadFlag_normalSave
}
...
func init() {
	...
	proto.RegisterEnum("types.RelaySaveBTCHeadFlag", RelaySaveBTCHeadFlag_name, RelaySaveBTCHeadFlag_value)
}
...
var fileDescriptor9 = []byte{
	...
	,
}
