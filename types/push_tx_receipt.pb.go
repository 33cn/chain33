...
func (*TxReceipts4SubscribePerBlk) Descriptor() ([]byte, []int) {
	return fileDescriptor_push_tx_receipt_dae4efb41ddcc34e, []int{0}
}
...
func (*TxReceipts4Subscribe) Descriptor() ([]byte, []int) {
	return fileDescriptor_push_tx_receipt_dae4efb41ddcc34e, []int{1}
}
...
func init() {
	proto.RegisterFile("push_tx_receipt.proto", fileDescriptor_push_tx_receipt_dae4efb41ddcc34e)
}

var fileDescriptor_push_tx_receipt_dae4efb41ddcc34e = []byte{
