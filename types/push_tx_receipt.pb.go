...
func (*TxReceipts4SubscribePerBlk) Descriptor() ([]byte, []int) {
	return fileDescriptor_push_tx_receipt_498eb2a58d49e648, []int{0}
}
...
func (*TxReceipts4Subscribe) Descriptor() ([]byte, []int) {
	return fileDescriptor_push_tx_receipt_498eb2a58d49e648, []int{1}
}
...
func init() {
	proto.RegisterFile("push_tx_receipt.proto", fileDescriptor_push_tx_receipt_498eb2a58d49e648)
}

var fileDescriptor_push_tx_receipt_498eb2a58d49e648 = []byte{
