...
func (b *Block) BtcHeader() *rTy.BtcHeader {
	return &rTy.BtcHeader{
		Hash:         b.Hash,
		Height:       b.Height,
...
func (t *TransactionResult) BtcTransaction() *rTy.BtcTransaction {
	btcTx := &rTy.BtcTransaction{}
	btcTx.Hash = t.Hash
	btcTx.Time = t.Time
	btcTx.BlockHeight = t.BlockHeight

	vin := make([]*rTy.Vin, len(t.Inputs))
